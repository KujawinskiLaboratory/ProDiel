...
```
# Filter volumes 
Filter volumes represent the amount (volume) of culture liquid that was filtered and thus biological material collected on the filter and extracted for metabolite concentrations. Value outputs from riMAVEN represent the ng/mL concentrations in the LC-MS vial, and need to be converted to represent the concentration in the full filtered volume.
## Load Data
...
filename <- paste0("Scripts/R/figures/PD22_pro11_cellCounts_extToZero_300dpi_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_pro11_cellCounts_extrapolatedToZero_300dpi_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_pro11_cellCycle_extToZero_300dpi_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_pro11_lightLevels_extToZero_300dpi_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_pro11_FALS_extToZero_300dpi_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_pro11_ChlCell_extToZero_300dpi_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_pro11_CellCount_FALS_extToZero_300dpi_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_pro11_combinedCellData_extToZero_300dpi_", today, "_bmg.png")
...
intra_seq <- read.csv("Altis/2023_0718_Pro11 RP Diel rerun/sequence_fromMethods/mtab_Pro11_RP_Diel_Altis_071823_rerun_forElMaven.csv")

#Load data quantified with the Mili-Q (MQ) generated standard curve
...
#Load data quantified with the Matrix-Matched (MM) generated standard curve
...
rm(intra_mm_quant_long,intra_mq_quant_long)

MW_EE <- distinct(rbind(EE_MW_mm,EE_MW_mq))

rm(EE_MW_mm,EE_MW_mq)

```

## Rename columns and extract/merge in various metadata
### MQ quantified metabolites
...
### MM quantified metabolites
```{r metabolite MM metadata, echo=FALSE, message=FALSE}

intra_mm_seq_filt <- intra_seq%>%
...
intra_MQ_z <-intra_MQ%>%
  group_by(mtabName)%>%
  filter(slope > 0)%>%
  mutate(mean_mtab = mean(Concentration_ngmL,na.rm=TRUE),sdev_mtab = sd(Concentration_ngmL,na.rm=TRUE))%>%
  filter(mean_mtab != 0, 
         sdev_mtab != 0)%>%
  group_by(mtabName,timepoint,type)%>%
  mutate(quantType = "MQ")
...
### MM quantified metabolites
Remove metabolites that are zero in all samples, have negative slopes, or have no curve data reported
```{r metabolite MM non zero}
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_rawNoQC_nonZeroMtabs_nonNorm_MQ_plots_", today, "_bmg.pdf")

# Save the plot
#pdf(filename, width = 11, height = 8.5)

# Get unique values of mtabName
unique_names <- unique(intra_MQ_z$mtabName)
...
```{r metabolite MM raw stacked plots}

# Create a PDF to save all plots

# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_rawNoQC_nonZeroMtabs_nonNorm_MM_plots_", today, "_bmg.pdf")

# Save the plot
#pdf(filename, width = 11, height = 8.5)

# Get unique values of mtabName
unique_names <- unique(intra_MM_z$mtabName)
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_rawNoQC_nonZeroMtabs_nonNorm_MQ_overlaid_plots_", today, "_bmg.pdf")
...
```{r metabolite MM raw overlaid plots}
# Create a PDF to save all plots

# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_rawNoQC_nonZeroMtabs_nonNorm_MM_overlaid_plots_", today, "_bmg.pdf")
...
Intra_z <- rbind(intra_MQ_z,intra_MM_z)
...
Intra_zrb <- Intra_zr %>%
  group_by(mtabName, timepoint, quantType) %>%
...
Intra_zrbm <- Intra_zrb %>%
  ...
  group_by(mtabName, quantType, timepoint) %>%
...
colnames(Intra_zrbmn)

Intra_zrbmn%>%
  select(mtabName,quantType,timepoint,replicateID,Sample.Type,Concentration_ngmL,
         mean_blank,diff_sample_blank,blank_adj_concentration,`Filtered weight (g)`,Blank_adj_concentration_ngmL_inSample)%>%
  mutate(timepoint = as.numeric(timepoint))%>%
  filter(mtabName == "sucrose pos",quantType == "MQ",Sample.Type !="QC")%>%
  arrange(timepoint,replicateID)%>%
  select(-c(Sample.Type,quantType))
...
Intra_zrbmn_mtabs <- Intra_zrbmn%>%
  mutate(mtab_quant = paste(mtabName,quantType))%>%
  select(mtab_quant)%>%
  deframe()%>%
  unique()%>%
  sort()
...
#write.csv(Intra_zrbmn_mtabs,"Z:/Brianna/Projects/Pro_Diel/Scripts/R/r_csv_outputs/Pro11_Intra_mtabNames_postQC_needDuplicateRemoval_20250422.csv")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_VolumeNorm_mtab_stacked_plots_LODfilt_", today, "_bmg.pdf")

# Save the plot
#pdf(filename, width = 11, height = 8.5)

# Get unique values of mtabName
unique_names <- unique(Intra_zrbmn$mtabName)%>%sort()
...
for (i in seq_along(unique_names)) {
  ...
  geom_rect(aes(xmin = 34, 
    ...
    facet_wrap(~quantType, ncol = 1,scales="free") +
...
dupList_filled <- read.csv(file = "Scripts/R/r_csv_outputs/Pro11_Intra_mtabNames_postQC_needDuplicateRemoval_20250422.csv")
...
Intra_zrbmnd <- Intra_zrbmn %>%
  mutate(mtab_quant = paste(mtabName,quantType))%>%
  filter(!mtab_quant %in% toRemove,
         quantType == "MQ")

view(Intra_zrbmnd)

unique(Intra_zrbmnd$mtab_quant)
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_nonNorm_vs_cellNorm_mtab_stacked_plots_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtab_plots_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtab_plots_first20_", today, "_bmg.png")

#ggsave(filename,plot=p1,height=11,width=20,dpi=300)

# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtab_plots_21to37_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtab_plots_first20_pointSmooth_", today, "_bmg.png")

#ggsave(filename,plot=p1,height=11,width=20,dpi=300)

# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtab_plots_21to37_pointSmooth_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_meanSdev_mtab_plots_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtab_plots_first20_pointSdev_", today, "_bmg.png")

#ggsave(filename,plot=p1,height=11,width=20,dpi=300)

# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtab_plots_21to37_pointSdev_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtab_heatmap_bypeakZscore_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtab_heatmap_bypeakZscore_", today, "_bmg.png")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_agCell_SequentialDifference_plot_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_agCell_T0subtracted_plot_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_rainSig24_LRsig_plots_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_Intra_cellNorm_temporalSig_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_Intra_cellNorm_temporalSig_allTimepoints_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtabRSD_vs_cellCycleEntropy_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_mtabRSD_vs_cellCycleEntropy_sig05_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_Intra_QCd_Mtab_RSD_overTime_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
#filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_stackedBar_cellCyle_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_stackedBar_moleFraction_cellCyle_", today, "_bmg.pdf")
...
# Generate the filename with the date automatically included
filename <- paste0("Scripts/R/figures/PD22_Pro11_QCd_cellNorm_treeMap_moleFraction_cellCyle_", today, "_bmg.pdf")
