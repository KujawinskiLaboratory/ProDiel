...
palette_48 <- createPalette(48, seedcolors = c("#ff0000", "#00ff00", "#0000ff"))
...
if (should_save) write.csv(x,"Scripts/R/Intracellular/r_csv_outputs/PD22_Pro11_Intra_fullQC_mtabQuant_agCell_wCurveInfo.csv")
...
if (should_save) write.csv(x,"Scripts/R/Intracellular/r_csv_outputs/PD22_Pro11_Intra_fullQC_mtabQuant_nM_wCurveInfo.csv")
...
if (should_save) write.csv(x, file = "Scripts/R/Intracellular/r_csv_outputs/PD22_Pro11_Intra_fullQC_quantTable_meanSD_agCell_byTime.csv", row.names = FALSE)
